...
// Selected options
export const showModeElement = document.getElementById('selected-mode');
export const showPlayerElement = document.getElementById('selected-player');
...
export const stopGameButtonElement = document.getElementById('stop-btn');
export const resetButtonElement = document.querySelector('.buttons button#restart-btn');
